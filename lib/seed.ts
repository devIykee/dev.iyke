...
export const seedCollaborations: Collaboration[] = [
  {
    id: "seed-col-cribx",
    org: "CribX",
    role: "Audited and completed the multi-chain deposit system",
    logo_url: null,
    link_url: null,
    category: "Client",
    sort_order: 0,
  ...
  {
    id: "seed-col-openfair",
    org: "Openfair",
    role: "Reported the High severity flaw in their launch flow; fix shipped in v2.0",
    logo_url: null,
    link_url: "https://openfair.app",
    category: "Security Research",
    sort_order: 1,
  },
  {
    id: "seed-col-robinhood-chain-protocols",
    org: "Robinhood Chain protocols",
    role: "Eleven private disclosures across launchpad, CDP and mining teams",
    logo_url: null,
    link_url: "/security-research",
    category: "Security Research",
    sort_order: 2,
  },
  {
    id: "seed-col-credchain",
    org: "CredChain",
    role: "Technical audit of the talent and credential platform",
    logo_url: null,
    link_url: null,
    category: "Security Research",
    sort_order: 3,
  ...
  {
    id: "seed-col-fbc-blockchain-club-futo",
    org: "FBC Blockchain Club, FUTO",
    role: "Community lead; run the club site and its technical programme",
    logo_url: null,
    link_url: null,
    category: "Community",
    sort_order: 4,
  },
  {
    id: "seed-col-ledger",
    org: "Ledger",
    role: "Built the FBC x Ledger invite contest site and referral leaderboard",
    logo_url: null,
    link_url: null,
    category: "Partner",
    sort_order: 5,
  ...
  {
    id: "seed-col-superteam-earn",
    org: "Superteam Earn",
    role: "Won the PayRam thread contest bounty",
    logo_url: null,
    link_url: "https://earn.superteam.fun",
    category: "Community",
    sort_order: 6,
  },
  {
    id: "seed-col-solanabr",
    org: "solanabr",
    role: "solana-surgeon-skill, submitted as PR #62 to skill-bounty",
    logo_url: null,
    link_url: "https://github.com/solanabr/skill-bounty/pull/62",
    category: "Open Source",
    sort_order: 7,
  },
  {
    id: "seed-col-flowvault",
    org: "FlowVault",
    role: "Covenant, an attestation gated treasury. Second place",
    logo_url: null,
    link_url: null,
    category: "Hackathon",
    sort_order: 8,
  ...
  {
    id: "seed-col-lepton-agents-hackathon",
    org: "Lepton Agents Hackathon",
    role: "Submitted Skimflow to the agents track",
    logo_url: null,
    link_url: null,
    category: "Hackathon",
    sort_order: 9,
  ...
  {
    id: "seed-col-ethereum-lima-2026",
    org: "Ethereum Lima 2026",
    role: "Solo entry on the Arbitrum track: a Stylus escrow with AI dispute resolution",
    logo_url: null,
    link_url: null,
    category: "Hackathon",
    sort_order: 10,
  ...
  {
    id: "seed-col-croo-agent-store",
    org: "CROO Agent Store",
    role: "Two AI video agent tools, VideoForgeAgent and MinecraftCast",
    logo_url: null,
    link_url: null,
    category: "Hackathon",
    sort_order: 11,
