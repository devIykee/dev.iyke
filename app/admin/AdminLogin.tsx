...
export default function AdminLogin({ configured }: { configured: boolean }) {
  ...
  return (
    <div className="flex min-h-screen items-center justify-center bg-neutral-950 px-4 font-chrome text-neutral-100">
      <div className="w-full max-w-sm rounded-2xl border border-neutral-800 p-8">
        ...
        <form onSubmit={onSubmit} className="mt-6 flex flex-col gap-3">
          <input
            ...
            className="rounded-lg border border-neutral-700 bg-black px-3 py-2 text-sm text-neutral-100 outline-none focus:border-neutral-400"
          />
